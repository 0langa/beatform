...
Last reconciled: **2026-08-15** (post v2.97.0 shipment and headless installed-update verification)
...
| Branch                  | `main`; release tag `v2.97.0` points at the 2.97.0 release commit; nothing follows the tag but this reconciliation                                                                                                                                                                                                                                                                                                                                                                                                                             |
| Source version          | `2.97.0` in all five version-bearing files; `node scripts/bump-version.mjs --verify` passed inside the release run                                                                                                                                                                                                                                                                                                                                                                                                                             |
| Release commit / tag    | `v2.97.0` points at the release commit ("The document that survives everything")                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| Latest public release   | `v2.97.0`, published 2026-08-15; downloaded installer and `SHA256SUMS.txt` agree on SHA-256 `f192c15b805d2c783798273e1bd73487603c7e4971e47cff2f3c70cd41af6a3b`; live `latest.json` serves `2.97.0`, names the v2.97.0 setup asset, and carries a 420-character signature                                                                                                                                                                                                                                                                       |
