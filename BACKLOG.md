...
Last reconciled: **2026-08-04** (post v2.68.0 — owner-feedback round 2)
...
| Source version          | `2.68.0` in all five version-bearing files                                                                                                            |
| HEAD / tag              | `f5e25f5` / `v2.68.0` (+ `94ef51a` audit-fix on main)                                                                                                 |
