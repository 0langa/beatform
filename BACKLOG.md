...
Last reconciled: **2026-08-14** (post v2.96.0 shipment and headless installed-update verification)
...
| Branch                  | `main`; release tag `v2.96.0` points at `a7c19f9`; nothing follows the tag but this reconciliation                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| Source version          | `2.96.0` in all five version-bearing files; `node scripts/bump-version.mjs --verify` passed inside the release run                                                                                                                                                                                                                                                                                                                                                                                                                             |
| Release commit / tag    | `v2.96.0` points at release commit `a7c19f9` ("The timeline grows up, and the guide answers back")                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| Latest public release   | `v2.96.0`, published 2026-08-14; downloaded installer and `SHA256SUMS.txt` agree on SHA-256 `f1df007e832e23d15081b0808c2f2ee85ba96abf859f2dc2cecf3a717d169899`; live `latest.json` serves `2.96.0`, names the v2.96.0 setup asset, and carries a 420-character signature                                                                                                                                                                                                                                                                       |
