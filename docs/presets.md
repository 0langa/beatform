...
| `dt`                                                                 | Seconds since the previous rendered frame. Scale per-frame effects by `dt * 60.0` so they look the same at 30, 60 and 144 fps. (This slot used to be `progress` = time/duration; nothing read it, and feedback presets needed frame-rate compensation more.) |
| `width`                                                              | Stereo width.                                                                                                                                                                                                                                                |
