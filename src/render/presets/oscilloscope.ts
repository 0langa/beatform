...
export const oscilloscope: PresetDef = {
  ...
  styles: [
    ...
    { id: "vapor", name: "Vapor", values: { hue: 290, glow: 0.8, hueWave: 60 } },
    {
      id: "clinical",
      name: "Clinical",
      values: { hue: 200, calm: 0.9, glow: 0.2, fill: 0, mirror: 0 },
    },
    {
      id: "phosphor",
      name: "Phosphor",
  ...
  params: [
    ...
    },
    {
      ...
      step: 0.01,
      default: 0.5,
      hint: "Neon halo around the trace line",
    },
    {
      key: "fill",
      label: "Fill",
  ...
  advanced: [
    ...
    },
    {
      ...
      step: 1,
      default: 24,
      hint: "Color shifts with the wave's height",
    },
    {
      key: "ghostDim",
      label: "Mirror ghost",
    ...
    },
    {
      ...
      step: 0.01,
      default: 0.06,
      hint: "Visibility of the background grid",
    },
    {
      key: "scanline",
      label: "Scanlines",
    ...
    },
    {
      ...
      step: 0.01,
      default: 0.1,
      hint: "Whole scope brightens on beats",
    },
    {
      key: "bgLevel",
      label: "Bg level",
