...
export const starfield: PresetDef = {
  ...
  styles: [
    ...
    { id: "snow", name: "Snowfall", values: { direction: 270, speed: 0.2, beatDance: 0.1, hue: 210, sizePulse: 0.3 } },
    { id: "rave", name: "Rave", values: { speed: 0.8, beatDance: 1, sizePulse: 1.6, twinkle: 0.8 } },
  ],
  params: [
  ...
  advanced: [
    ...
    { key: "hueVariance", label: "Hue variance", min: 0, max: 180, step: 5, default: 40, hint: "Random per-particle color variation" },
    { key: "twinkle", label: "Twinkle", min: 0, max: 1, step: 0.02, default: 0.4, hint: "Per-particle brightness shimmer" },
    { key: "glow", label: "Glow halo", min: 0, max: 1, step: 0.02, default: 0.35, hint: "Soft halo around the crisp particle core" },
    { key: "brightness", label: "Brightness", min: 0.2, max: 1.5, step: 0.05, default: 0.8, hint: "Overall particle brightness" },
    { key: "beatFlash", label: "Beat flash", min: 0, max: 0.5, step: 0.01, default: 0.1, hint: "Background pulse on beats" },
    { key: "bgLevel", label: "Bg level", min: 0, max: 0.1, step: 0.005, default: 0.02, hint: "Background wash brightness" },
