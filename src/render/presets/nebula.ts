...
export const nebula: PresetDef = {
  ...
  styles: [
    ...
    // Fractal Ice — fine scale plus pin-point sparkle: a crystalline 6-fold.
    {
      id: "fractalIce",
      name: "Fractal Ice",
      values: {
    ...
    // Solar Flare — fast flow, wide ripple, hot core blowing out — a flare.
    {
      id: "solar",
      name: "Solar Flare",
      values: {
    ...
    // Mandala — 12-fold, nearly frozen flow, fast rotation: a spinning rose.
    {
      id: "mandala",
      name: "Mandala",
      values: {
    ...
    // Oil Slick — unfolded, full hue range keyed to density — an iridescent film.
    {
      id: "oilSlick",
      name: "Oil Slick",
      values: {
