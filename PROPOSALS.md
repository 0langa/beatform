...
| P-19     | **ROSTER OPEN — 1 of 5 executed** | Entry 1 (spectrogram waterfall) executed as the `spectro-falls` mode; GPU matrix re-blessed at `9494ba8` (2026-08-16 truth sweep) — code-complete, release imminent (2.99.0). The remaining four stay ranked and unauthorized.                                                |
